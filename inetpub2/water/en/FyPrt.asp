...
<br><b5>全年結(Epson 890)</b>
<form method="post" action="Fyearprintn.asp" name="form1">
...
%>                  
	...
	<tr>
		...
		<td></td>
		<td>
                  <input type="text" name="Nyear" value="<%=Nyear%>" size="4">
		</td>
	</tr>
	<tr>
		...
		<td></td>
		<td>
                  <input type="text" name="Nrate" value="<%=Nrate%>" size="4">
		</td>
	</tr>
	<tr>
