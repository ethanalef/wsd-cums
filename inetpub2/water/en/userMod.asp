	...
	If Not ValidateUser(username, password) Then
		...
		if not rs.eof then
		   id = username
                   ...
                   if  rs("Reporting16")=True then Tsc7G = 1 else Tsc7G = 0 end if
                   if  rs("Reporting17")=True then Tsc7H = 1 else Tsc7H = 0 end if
                   if  rs("Reporting18")=True then Tsc7I = 1 else Tsc7I = 0 end if
...
if request.form("action") <> "" then
	...
	End If
		...
		rs("username") = username
                   ...
                   if  Tsc7F = 1 then rs("Reporting15")=True else rs("Reporting15")=false end if
                   if  Tsc7G = 1 then rs("Reporting16")=True else rs("Reporting16")=false end if
                   if  Tsc7H = 1 then rs("Reporting17")=True else rs("Reporting17")=false end if
                   if  Tsc7I = 1 then rs("Reporting18")=True else rs("Reporting18")=false end if
