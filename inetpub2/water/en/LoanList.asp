...
<table border="0" cellpadding="0" cellspacing="0" width="900">
	...
	<form method="post" action="LoanListPrint.asp" name="form1" onsubmit="return validating1()">
	<input type=hidden name="from" value="<% =Request.servervariables("script_name") %>">
	<tr>
		<td valign="top" align="center">
			<table border="0" cellpadding="0" cellspacing="0" width="270">
				<tr>
					<td width="100" align="right" class="b8"><font color=#FF0000>* </font>日期 由此:</td>
					<td width="10"></td>
					<td width="160">
				...
				<tr>
					<td align="right" class="b8"><font color=#FF0000>* </font>日期 直至:</td>
					<td></td>
					<td>
				...
				<tr>
					<td align="right" class="b8"><font color=#FF0000>* </font>社員 由:</td>
					<td></td>
					<td>
				...
				<tr>
					<td align="right" class="b8"><font color=#FF0000>* </font>社員 至:</td>
					<td></td>
					<td>
