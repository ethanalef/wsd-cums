...
rs1.close
   ...
   if left(ms("code"),1) ="E" or ms("code")="0D" or ms("code")="D0" or ms("code")="D1" OR ms("code")="DE" or ms("code")="NE" or  ((ms("code")="F3"  or ms("code")="F1" or ms("code")="F2" or ms("code")="F0" ) and MX=0)  then
        if left(ms("code"),1) ="E" or ms("code")="0D" or ms("code")="D0" or ms("code")="D1" then
          lnnum(xx) = ms("lnnum")
           newln = 0
           xyear = year(ms("ldate"))
           xmon  = month(ms("ldate"))
           ...
           lcode(xx) = LoanCode(ms("code")) 
            ...
            if (ms("CODE")="F3" or ms("code")="F1" or ms("code")="F2"  or ms("code")="F0") AND mx = 0 THEN
              ...
              select case ms("code") 
                      case "F3"
                            if ms("ldate") = ldate(xx-1) and ldate(xx-1) = ldate(xx-2) then
                                LNIAMT(XX-2)=ms("AMOUNT")
                                      ms.movenext 
                                if not ms.eof and ms("code") = "F3" and ms("ldate") = ldate(xx-1) then
                      ...
                      case "F1","F2"
                          ...
                          if ms("ldate") = ldate(xx-1) and "F"&right(xcode(xx-1),1)=ms("code") then 
                             LNIAMT(XX-1)=ms("AMOUNT")
                             ...
                             if ms("ldate") = ldate(xx-2) and "F"&right(xcode(xx-2),1)=ms("code") then
                                LNIAMT(XX-2)=ms("AMOUNT")
                             else
