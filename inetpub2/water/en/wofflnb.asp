                 ...
                 xrepaydate = right(repaydate,4)&"/"&mid(repaydate,4,2)&"/"&left(repaydate,2)
                           ...
                           if cashamt <>0 then
    			            ...
    			            conn.execute("update loanrec set bal= bal-"&cashamt&" where lnnum='"&lnnum&"' " )
                                    ...
                                    conn.execute("insert into loan (memno,lnnum,code,ldate,amount,pflag) values ('"&memno&"','"&lnnum&"','EC','"&xrepaydate&"',"&cashamt&",0 ) ")                           
...
<br>
<form name="form1" method="post" action="wofflnb.asp">
...
<div><center><font size="3">劃消貸款建立</font></center></div>
<center>
