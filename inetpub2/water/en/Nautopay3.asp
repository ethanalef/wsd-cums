...
if request("submit")<>"" then
    ...
    do while not rs.eof
        ...
        if lnnum<>"" then
			...
			if year(date())=2021 and month(date())=9 and memno=20  then sumttl=0	end if
            select case mstatus
            case "A"
                if sumttl > 0 then
            ...
            case "0" 
		   	...
		   	'if year(date())=2021 and month(date())=8 and memno=2527 then
			'	conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('2527','2021-08-31','A1','600.00','600.00',0,'A','N' ,'2021-08-24',0,0 ) ")  
			'end if   
			
		    if year(date())=2021 and month(date())=9 and memno=20  then
				conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','F1','682.69','682.69',0,'A','N' ,'2021-09-24',0,0 ) ")  
				conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','E1','3672.00','3672.00',0,'A','N' ,'2021-09-24',0,0 ) ")  
				'conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','A1','300.00','300.00',0,'A','N' ,'2021-09-24',0,0 ) ")  
			end if            
		    if year(date())=2021 and month(date())=10 and memno=20  then
				conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','F1','657.97','657.97'  ,0,'A','N' ,'2021-10-30',0,0 ) ")  
				conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','E1','3672.00','3672.00',0,'A','N' ,'2021-10-30',0,0 ) ")  
				conn.execute("insert into autopay (memno,adate,code,bankin,curamt,updamt,status,flag,pdate,deleted,pflag) values ('20','2021-09-30','A1','300.00','300.00',0,'A','N' ,'2021-10-30',0,0 ) ")  
			end if 
