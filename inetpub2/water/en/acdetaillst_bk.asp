...
<%
   ...
   enddate = right("0"&day(date()),2)&"/"&right("0"&month(date()),2)&"/"&(year(date()))
...
<table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="right" class="b12">開始交易日期</td>
		    <td width="10"></td>
		    <td><input type="text" name="stdate" value="<%=stdate%>" size="10" onblur="if(!formatDate(this)){this.value=''};"></td>
            </tr>
            <td align="right" class="b12">完結交易日期</td>
		    <td width="10"></td>
		    <td><input type="text" name="enddate" value="<%=enddate%>" size="10" onblur="if(!formatDate(this)){this.value=''};"></td>
            </tr>
	<tr>
