...
if not ms.eof then
	...
	do while not ms.eof 
        ...
        case 	"B1","MF"
				...
				if  shareCurrDate <= ms("ldate") then
						for i = 1 to 12
							if dvdate(i)<= shareBalanceDate then
								divd(i) = sbal(xx)
							end if
        ...
        for i = 1 to 12
			...
			if divd(i)= 0 then
				...
				'***********************************************************			
					...
					if rs("memno")=2831 and sldate="01/10/2020"  then	divd(i)=2327.90  	end if
					if rs("memno")=4986 and sldate="01/07/2020"  then	divd(i)=2500	   	end if

					if rs("memno")=1078 and sldate="01/07/2020"  then	divd(i)=155012.82   end if
					if rs("memno")=1078 and sldate="01/08/2020"  then	divd(i)=156512.82	end if
					if rs("memno")=1078 and sldate="01/09/2020"  then	divd(i)=158012.82	end if				
					if rs("memno")=1078 and sldate="01/10/2020"  then	divd(i)=159512.82	end if					
					if rs("memno")=1078 and sldate="01/11/2020"  then	divd(i)=160012.82	end if					
					if rs("memno")=1078 and sldate="01/12/2020"  then	divd(i)=160012.82 	end if					
					if rs("memno")=1078 and sldate="01/01/2021"  then	divd(i)=160012.82	end if					
					if rs("memno")=1078 and sldate="01/02/2021"  then	divd(i)=160012.82   end if					
					if rs("memno")=1078 and sldate="01/03/2021"  then	divd(i)=160012.82  	end if				
					if rs("memno")=1078 and sldate="01/04/2021"  then	divd(i)=160012.82	end if
			
					if rs("memno")=4629 and sldate="01/07/2020"  then	divd(i)=614.10   	end if
					if rs("memno")=4629 and sldate="01/08/2020"  then	divd(i)=614.10		end if
					if rs("memno")=4629 and sldate="01/09/2020"  then	divd(i)=614.10		end if				
					if rs("memno")=4629 and sldate="01/10/2020"  then	divd(i)=614.10		end if					
					if rs("memno")=4629 and sldate="01/11/2020"  then	divd(i)=614.10		end if					
					if rs("memno")=4629 and sldate="01/12/2020"  then	divd(i)=1114.10 	end if					
					if rs("memno")=4629 and sldate="01/01/2021"  then	divd(i)=1114.10		end if					
					if rs("memno")=4629 and sldate="01/02/2021"  then	divd(i)=1114.10  	end if					
					if rs("memno")=4629 and sldate="01/03/2021"  then	divd(i)=1114.10  	end if				
					if rs("memno")=4629 and sldate="01/04/2021"  then	divd(i)=1114.10  	end if	


					if rs("memno")=4858 and sldate="01/07/2020"  then	divd(i)=1628.00    	end if
					if rs("memno")=4858 and sldate="01/08/2020"  then	divd(i)=1628.00		end if
					if rs("memno")=4858 and sldate="01/09/2020"  then	divd(i)=3128.00		end if				
					if rs("memno")=4858 and sldate="01/10/2020"  then	divd(i)=4628.00		end if					
					if rs("memno")=4858 and sldate="01/11/2020"  then	divd(i)=4628.00		end if					
					if rs("memno")=4858 and sldate="01/12/2020"  then	divd(i)=4628.00 	end if					
					if rs("memno")=4858 and sldate="01/01/2021"  then	divd(i)=4628.00		end if					
					if rs("memno")=4858 and sldate="01/02/2021"  then	divd(i)=4628.00  	end if					
