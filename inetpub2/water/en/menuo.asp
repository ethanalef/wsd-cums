...
case 4 ''Administrator
	...
	jo_sub_menu_text = "加入新社員,社員資料修正,hr,新社員開戶建立"
	jo_sub_menu_link =  "memberAdd.asp, memberMod1.asp,hr,newacc.asp"
	...
	jo_sub_menu_text = "貸款申請,新貸款建立,貸款修正,hr,現金還款,股金還款"
	jo_sub_menu_link = "loan.asp,nloanDetail.asp,ncloandetail.asp,hr,repayloan.asp,saveloan.asp"
	...
	jo_sub_menu_text = "轉賬建立,輸入銀行脫期貸款,銀行轉賬過數,銀行轉賬試算,銀行轉賬超額試算,hr,庫房轉賬過數,庫房轉賬試算"
	jo_sub_menu_link = "nautopay.asp,autoadj.asp,autoupd.asp,atList.asp,atovList.asp,hr,sadtupd.asp,sdList.asp"
	...
	'jo_sub_menu_text = "Loan application Assessment,Loan Application Assessment Reports" 
	jo_sub_menu_text = "股息計算操作,股息列印,股息過數,hr,退股建立,現金入賬建立"
	jo_sub_menu_link = "dvdcal.asp,divdlist.asp,divpass.asp,hr,savewithd.asp,savecash.asp"
	...
	jo_sub_menu_text = "社員資料查詢,hr,會議紀錄,董事會報告書,委員資料修正,hr,支票對數"
	jo_sub_menu_link = "acdetail2.asp,hr,meetingNotes.asp,monthlyReport.asp,handleParty.asp,hr,cheque.asp"
...
select case session("userLevel")
	...
	jo_menu_text = "社員資料,貸款,清計數操作,自動轉賬,股金,個人戶口,總賬,報表,其他,登出 "
