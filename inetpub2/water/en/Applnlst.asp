<%requiredLevel=3%>
<%
  stdate1 = right("0"&day(date()),2)&"/"&right("0"&month(date()),2)&"/"&year(date())-1
...
<form  method="post" action="ApplnlstPrint.asp" name="form1">
<table border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="10"></td>
		<td><input type="text" name="memNo" value="<%=memNo%>" size="10" >				
                （輸入 ＊　全部）
		</td>
	</tr>
	<tr>
		<td align="right" class="b8">狀況</td>
		<td width="10"></td>
		<td>
			...
			<option value="CR">巳拒絕
                        <option value="CP">審核中
			<option value="DA">董事巳批准
			<option value="DR">董事巳拒絕
			<option value="DP">董事審核中
			<option value="all">全選
			</select>
