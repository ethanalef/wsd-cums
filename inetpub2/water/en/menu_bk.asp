...
<DIV id='menu3' class='menu' onMouseover='activateMenu(3);'>
	<table cellpadding='0' cellspacing='0'>
		...
		<tr><td colspan='2'><A href='crash.asp'>破產操作建立</A></td></tr> 
                <tr><td colspan='2'><A href='chlst.asp'>破產列印</A></td></tr>   
		<% End If %>
		<% if Session("userRight_x_cLoan6") Then %><tr><td colspan='2'>
		<HR STYLE=' color: #CCCCCC' SIZE=1 width='100%'></td></tr>		
		<tr><td colspan='2'><A href='IvaPro.asp'>IVA操作建立</A></td></tr> 
                <tr><td colspan='2'><A href='IvaPlst.asp'>IVA列印</A></td></tr>   
		<% End If %>
	</table>
</DIV>
...
<DIV id='menu4' class='menu' onMouseover='activateMenu(4);'>
	<table cellpadding='0' cellspacing='0'>
		...
		<% if Session("userRight_x_AutoPay3") Then %><tr><td colspan='2'><A href='autopass.asp'>銀行轉帳磁碟建立</A></td></tr><% End If %>
		<% if Session("userRight_x_AutoPay4") Then %><tr><td colspan='2'><A href='AutoAdkt.asp'>銀行脫期建立</A></td></tr><% End If %>
		
		<% if Session("userRight_x_AutoPay5") Then %><tr><td colspan='2'><A href='autoupd.asp'>銀行轉帳過數 </A></td></tr><% End If %>
                <% if Session("userRight_x_AutoPay6") Then %><tr><td colspan='2'><A href='autolstpro.asp'>銀行自動轉帳失效通知書建立</A></td></tr><% End If %>
               
		<% if Session("userRight_x_AutoPay7") Then %><tr><td colspan='2'>
		<HR STYLE=' color: #CCCCCC' SIZE=1 width='100%'></td></tr>
		<tr><td colspan='2'><A href='AutoBdkt.asp'>庫房脫期建立</A></td></tr>
		<% End If %>
		
		<% if Session("userRight_x_AutoPay8") Then %><tr><td colspan='2'><A href='sadtupd.asp'>庫房過數</A></td></tr><% End If %>
		<% if Session("userRight_x_AutoPay9") Then %><tr><td colspan='2'>
		<HR STYLE=' color: #CCCCCC' SIZE=1 width='100%'></td></tr>
                 
		<tr><td colspan='2'><A href='plnlst.asp'>特別個案轉帳試算</A></td></tr>

		<% End If %>
                <% if Session("userRight_x_AutoPay10") Then %><tr><td colspan='2'><A href='atList.asp'>銀行轉帳試算</A></td></tr><% End If %>
                <% if Session("userRight_x_AutoPay11") Then %><tr><td colspan='2'><A href='RejectLst.asp'>銀行自動轉帳失效通知書列印</A></td></tr><% End If %>
                <% if Session("userRight_x_AutoPay12") Then %><tr><td colspan='2'><A href='atovList.asp'>銀行轉帳超額細明表</A></td></tr><% End If %> 
...
<DIV id='menu7' class='menu' onMouseover='activateMenu(7);'>
	<table cellpadding='0' cellspacing='0'>
		...
		<% if Session("userRight_x_Reporting2") Then %><tr><td colspan='2'><A href='delinquentReport.asp'>呆賬報告</A></td></tr><% End If %>
...
<DIV id='menu8' class='menu' onMouseover='activateMenu(8);'>
	<table cellpadding='0' cellspacing='0'>
		<% if Session("userRight_x_statist1") Then %><tr><td colspan='2'><A href='InsurLst.asp'>社員統計資料分部報告</A></td></tr><% End If %>
                <% if Session("userRight_x_statist1") Then %><tr><td colspan='2'><A href='memIlst.asp'>社員報告(保險)</A></td></tr><% End If %>
                <% if Session("userRight_x_statist1") Then %><tr><td colspan='2'><A href='memRlst.asp'>社員報告(註冊官)</A></td></tr><% End If %> 
...
<DIV id='menu9' class='menu' onMouseover='activateMenu(9);'>
	<table cellpadding='0' cellspacing='0'>
		...
		<% if Session("userRight_x_Other3")Then %><tr><td colspan='2'><A href='user.asp'>用戶管理</A></td></tr><% End If %>
