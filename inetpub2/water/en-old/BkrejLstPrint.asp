...
SQl = "select A.*,b.memname,b.memcname  from autopay a,memmaster b where a.memno=b.memno and right(a.code,1)='1'and flag='F'  order by a.memno   "
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<td colspan="15"><font size="4">銀行轉賬失效細明表 <%=mndate%></font></td>
	</tr>
	
	<tr height="35" valign="top" align="center">
	<td colspan="15"><font size="4">日期 : <%=mndate%></font></td>
	</tr>
...
<table border="0" cellpadding="0" cellspacing="0">
	<br>
        <tr>
           <td width="30"></td>
           <td width="170" align="right"><b>銀行轉帳失效合共 :</b></td> 
           <td width="17"><%=formatNumber(ttlasamt,2)%></td>
