...
if request("submit")<>"" then
	...
	rs.open sql, conn, 1, 1       
        do while not rs.eof 
           ...
           conn.execute("update memmaster set bnk = '"&rs("bnk")&"' where memno='"&rs("acct")&"' ")
           conn.execute("update memmaster set bch = '"&rs("bch")&"' where memno='"&rs("acct")&"' ")
           conn.execute("update memmaster set bacct = '"&rs("bacct")&"' where memno='"&rs("acct")&"' ")
