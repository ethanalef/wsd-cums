...
if approval <> "" then
        select case Approval
               case "批准申請"
                    ...
                    xapproval="Approved"
                    if  sql_filter <>""  then  
                         sql_filter = sql_filter & " and (firstapproval='"&xapproval&"' or SecondApproval ='"&xapproval&"' )  "    
                    else
                        sql_filter = sql_filter & " (firstapproval='"&xapproval&"' or SecondApproval='"&xapproval&"' )  "     
                    end if
               case "拒絕申請"
