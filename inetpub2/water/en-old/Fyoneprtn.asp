...
SQl = "select memno,memname,memcname,mstatus  from memmaster where memno = '"&xmemno&"' and   accode='"&memno&"'   and mstatus not in ('8','9','C','P','V','L','B' ) order by memno   "
