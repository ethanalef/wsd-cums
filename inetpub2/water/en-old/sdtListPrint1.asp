...
<%
SQl = "select * from memmaster where (mstatus='T' or mstatus='M') order by memno "
...
elseif request.form("output")="text" then
	...
	do while not rs.eof
		...
		objFile.Write rs("memcname")&spaces,25)
	...
	objFile.Write right(spaces&formatnumber(ttlTemp,2),22)
	objFile.WriteLine ""
...
<table border="0" cellpadding="0" cellspacing="0">
	...
	<td colspan="15"><font size="4">庫房轉賬細明表</font></td>
	</tr>
