...
SQl = "SELECT  memno,memname,memcname,mstatus FROM  memmaster  WHERE   MSTATUS='B'   ORDER BY  memno,memname,memcname,mstatus "
...
<table border="0" cellpadding="0" cellspacing="0" >
	<tr height="30" valign="top" align="center"><td colspan="15"><font size="3"  face="標楷體" >水務署員工儲蓄互助社<br>破產列表<br><font size="2"  face="標楷體" >日期 : <%=mndate%></td></tr>
...
<%
        ...
        memno=rs("memno")
            XAMT = 0
            lnamt = 0
            set ms=conn.execute("select *  from share where memno='"&memno&"' and ldate<='"&ddate&"'  ")
                  do while not ms.eof
