...
if request("submit")<>"" then
        ...
        sql = "select * from loan  where memno='1407' and code='D1' and ldate ='2011/08/31' "
        rs.open sql ,conn,1,1 
         do while rs.eof   
             xdate = dateadd("s","31-Aug-2011 16:10:00")
             conn.execute(" update loan set ldate= '"&xdate&"' where memno='1407' and code='D1' and ldate ='2011/08/31' ")
         rs.movenext
         loop
         rs.close
