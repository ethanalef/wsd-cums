...
if request.form("Search")<>"" or id <>""  then
 cashamt=0
	...
	Next
                ...
                set rs=conn.execute("select a.memno,a.memname,a.memcname,a.mstatus,b.* from memmaster a,dividend b where a.memno='"&memno&"'  and b.memno=a.memno and b.bank='B'   ")
                if not rs.eof then
...
<br>
<form name="form1" method="post" action="shpreject.asp">
...
<div><center><font size="3">派息轉帳失效建立</font></center></div>
<br>
...
<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width=50></td>
				<td><input type="text" name="memName" value="<%=memName%>" size="30"<%if id<>"" then response.write " onfocus=""form1.bank.focus();""" end if%>>
