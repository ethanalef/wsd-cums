...
if instr(mname,"(1-500)") > 0 then
             styfield = styfield & "memno<='500' and "
else
if instr(mname,"(501-1000)") > 0 then
      styfield = styfield & " (memno>='501' and  memno<='1000') and "
else 
if instr(mname,"(1001-1500)") > 0 then
      styfield =styfield &  " (memno>='1001' and  memno<='1500') and "
else 
if instr(mname,"(1501-2000)") > 0 then
      styfield =styfield &  " (memno>='1501' and  memno<='2000') and "
else 
if instr(mname,"(2001-2500)") > 0 then
      styfield =styfield &  " (memno >='2001' and   memno<='2500') and "
else
if instr(mname,"(2501-3000)") > 0 then
      styfield = styfield & " (memno >='2501' and   memno<='3000') and "
else
if instr(mname,"(3001-5000)") > 0 then
      styfield =styfield &  " (memno >='3001' and   memno<='5000') and "
else
   styfield = ""
end if
end if
...
<%end if%>
<%else%>
<font face="arial, helvetica, sans-serif" size="2" ><b>　　　　　 - (2) 閣下於本年度股息為<%=formatnumber(ttlamt,2)%>元，已存入閣下的股金內。</b></font><br>
<%end if%>
