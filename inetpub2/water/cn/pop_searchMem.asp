...
<!--
	...
	window.opener.document.form1.firstAppointDate.value = '<% =rs("firstAppointDate") %>';
	window.opener.document.all.tags( "td" )['firstAppointDate'].innerHTML='<% =rs("firstAppointDate") %>';
